  ...
  const sections = [
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="palette" size={20} /> Branding
        </span>
      ),
      items: [
    ...
    },
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="globe" size={20} /> Localization
        </span>
      ),
      items: [
        {
    ...
    },
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="credit-card" size={20} /> MTN MoMo
        </span>
      ),
      items: [
        {
          label: 'Environment',
          key: 'momo.environment',
          type: 'select',
          options: [
    ...
    },
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="mail" size={20} /> Notifications
        </span>
      ),
      items: [
    ...
    },
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="lock" size={20} /> Security
        </span>
      ),
      items: [
        {
    ...
    },
    {
      title: (
        <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <OnlineLogoIcon name="hard-drive" size={20} /> Backup
        </span>
      ),
      items: [
      ...
      {activeTab === 'account' && (
        <div className="grid grid-2" style={{ gap: 'var(--space-lg)', alignItems: 'start' }}>
          <div>
            ...
            <div
              className="glass-card-static animate-fade-in-up stagger-2"
            ...
            >
              <div className="flex-between">
                <div>
                  ...
                  >
                    <OnlineLogoIcon name="moon" size={20} /> Appearance
                  </h3>
                  <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)' }}>
                ...
                >
                  ...
                  >
                    {theme === 'dark' ? (
                      <OnlineLogoIcon name="moon" size={14} color="#000" />
                    ) : (
                      <OnlineLogoIcon name="sun" size={14} color="#000" />
                    )}
                  </div>
                </button>
              </div>
          ...
          <div
            className="glass-card-static animate-fade-in-up stagger-3"
            style={{ padding: 'var(--space-lg)' }}
          >
            <h3
              style={{
        ...
        <div className="grid grid-2" style={{ gap: 'var(--space-lg)', alignItems: 'start' }}>
          <div className="flex-col" style={{ gap: 'var(--space-lg)' }}>
            {(user?.role === 'SUPER_ADMIN' ||
              ...
              >
                ...
                >
                  Create an alternative admin account.
                </p>
          ...
          <div className="flex-col" style={{ gap: 'var(--space-lg)' }}>
            {[sections[0], sections[1]].map((section, i) => (
              <div
                key={i}
                className={`glass-card-static animate-fade-in-up stagger-${i + 2}`}
                style={{ padding: 'var(--space-lg)' }}
              >
                <h3
                  style={{
