            ...
            <div key={campaign.id} className={`campaign-card animate-fade-in-up stagger-${i + 1}`}>
              ...
              >
                <OnlineLogoIcon
                  ...
                  size={48}
                  color={campaign.status === 'completed' ? 'var(--emerald)' : 'var(--gold)'}
                />
                {campaign.featured && (
                  <span
              ...
              <div className="campaign-card-body">
                ...
                <div className="campaign-card-stats">
                  <span>
                    <strong>{formatCurrency(campaign.raised, campaign.currency)}</strong> raised
                  </span>
                  <span>
                    {pct}% of {formatCurrency(campaign.goal, campaign.currency)}
                  </span>
                </div>
                <div
