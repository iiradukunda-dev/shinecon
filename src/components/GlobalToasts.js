          ...
          return (
            <div key={t.id} className="toast" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ width: '1px', height: '32px', backgroundColor: 'rgba(255,255,255,0.1)', margin: '0 16px' }}></div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <span style={{ color: '#fff', fontSize: '15px', fontWeight: '600' }}>{t.title}</span>
                  <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '14px', marginTop: '2px' }}>{t.message}</span>
                </div>
              </div>
