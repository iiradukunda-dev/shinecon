...
export const DEMO_CONTRIBUTION_TYPES = [
  { id: 'ct1', name: 'Monthly Contribution', description: 'Regular monthly contribution to support ministry operations', category: 'Regular', localStudent: 2000, localEmployed: 5000, diasporaStudent: 10, diasporaEmployed: 30, currency: { local: 'RWF', diaspora: 'USD' }, recurring: true, active: true, icon: 'https://api.iconify.design/lucide:wallet.svg?color=%23D4A843', color: '#D4A843' },
  { id: 'ct2', name: 'Building Fund', description: 'Contribution towards the new church building project', category: 'Project', localStudent: 1000, localEmployed: 3000, diasporaStudent: 5, diasporaEmployed: 20, currency: { local: 'RWF', diaspora: 'USD' }, recurring: true, active: true, icon: 'https://api.iconify.design/lucide:building-2.svg?color=%233B5BDB', color: '#3B5BDB' },
  { id: 'ct3', name: 'Youth Ministry', description: 'Supporting youth programs and activities', category: 'Ministry', localStudent: 500, localEmployed: 2000, diasporaStudent: 5, diasporaEmployed: 15, currency: { local: 'RWF', diaspora: 'USD' }, recurring: false, active: true, icon: 'https://api.iconify.design/lucide:sparkles.svg?color=%232B8A3E', color: '#2B8A3E' },
  { id: 'ct4', name: 'Choir Fund', description: 'Equipment, costumes, and choir event support', category: 'Ministry', localStudent: 500, localEmployed: 1500, diasporaStudent: 3, diasporaEmployed: 10, currency: { local: 'RWF', diaspora: 'USD' }, recurring: false, active: true, icon: 'https://api.iconify.design/lucide:music.svg?color=%239C36B5', color: '#9C36B5' },
  { id: 'ct5', name: 'Mission Support', description: 'Funding missions and outreach programs', category: 'Mission', localStudent: 1000, localEmployed: 3000, diasporaStudent: 10, diasporaEmployed: 25, currency: { local: 'RWF', diaspora: 'USD' }, recurring: false, active: true, icon: 'https://api.iconify.design/lucide:globe.svg?color=%23E8590C', color: '#E8590C' },
  { id: 'ct6', name: 'Special Offering', description: 'Special seasonal or event-based offerings', category: 'Special', localStudent: 0, localEmployed: 0, diasporaStudent: 0, diasporaEmployed: 0, currency: { local: 'RWF', diaspora: 'USD' }, recurring: false, active: true, icon: 'https://api.iconify.design/lucide:gift.svg?color=%23F59F00', color: '#F59F00' },
];
...
export const DEMO_CAMPAIGNS = [
  { id: 'camp1', title: 'New Church Building', description: 'Building a house of worship that will serve generations. Our vision is to create a space that glorifies God and brings the community together.', goal: 50000000, raised: 32450000, currency: 'RWF', startDate: '2025-01-01', endDate: '2026-12-31', status: 'active', featured: true, contributors: 89, image: 'https://api.iconify.design/lucide:church.svg?color=%23D4A843' },
  { id: 'camp2', title: 'Youth Mission Trip', description: 'Sending 20 young people to spread the gospel and serve communities in need across East Africa.', goal: 5000000, raised: 3200000, currency: 'RWF', startDate: '2026-06-01', endDate: '2026-09-30', status: 'active', featured: true, contributors: 45, image: 'https://api.iconify.design/lucide:globe.svg?color=%233B5BDB' },
  { id: 'camp3', title: 'Worship Equipment', description: 'Upgrading our sound system, instruments, and stage lighting for a more impactful worship experience.', goal: 8000000, raised: 8000000, currency: 'RWF', startDate: '2025-06-01', endDate: '2026-03-31', status: 'completed', featured: false, contributors: 67, image: 'https://api.iconify.design/lucide:music.svg?color=%239C36B5' },
  { id: 'camp4', title: 'Community Outreach', description: 'Providing food, clothing, and spiritual support to underserved communities around Kigali.', goal: 3000000, raised: 1850000, currency: 'RWF', startDate: '2026-04-01', endDate: '2026-10-31', status: 'active', featured: false, contributors: 34, image: 'https://api.iconify.design/lucide:heart.svg?color=%232B8A3E' },
];
...
export const DEMO_ANNOUNCEMENTS = [
  { id: 'a1', title: 'Annual Conference Registration Open', category: 'Events', priority: 'high', date: '2026-07-18', description: 'Registration is now open for the 2026 Annual Ministry Conference. Early bird discounts available until August 15th.', image: 'https://api.iconify.design/lucide:megaphone.svg?color=%23E8590C' },
  { id: 'a2', title: 'New Building Fund Update', category: 'Fundraising', priority: 'normal', date: '2026-07-15', description: 'We have reached 65% of our building fund goal! Thank you for your generous contributions. Let\'s keep the momentum going.', image: 'https://api.iconify.design/lucide:building-2.svg?color=%23D4A843' },
  { id: 'a3', title: 'Prayer Week Starting Monday', category: 'Prayer', priority: 'high', date: '2026-07-19', description: 'Join us for a special week of prayer and fasting starting this Monday through Friday. Services at 6 AM and 7 PM daily.', image: 'https://api.iconify.design/lucide:sparkles.svg?color=%232B8A3E' },
  { id: 'a4', title: 'Youth Camp Registration', category: 'Youth', priority: 'normal', date: '2026-07-12', description: 'Youth camp spots are filling up fast! Register your children aged 13-18 for an unforgettable week of faith and fun.', image: 'https://api.iconify.design/lucide:users.svg?color=%233B5BDB' },
  { id: 'a5', title: 'Volunteer Appreciation Sunday', category: 'News', priority: 'low', date: '2026-07-10', description: 'Join us this Sunday as we honor and celebrate all our amazing volunteers who serve faithfully.', image: 'https://api.iconify.design/lucide:award.svg?color=%23F59F00' },
];
